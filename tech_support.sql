...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2016 at 10:26 AM
...
(1015, 'Gonzalo', 'Keeton', '27371 Valderas', 'Mission Viejo', 'CA', '92691', 'US', '(214) 555-3647', 'gonzakee@delete.com', 'sesame'),
...
INSERT INTO `products` (`id`, `productCode`, `name`, `version`, `releaseDate`) VALUES
...
(5, 'TEAM10', 'Team Manager Version 1.0', '1.0', '2012-06-01 00:00:00'),
...
(9, 'TEST10', 'Test Product', '1.0', '2014-12-01 00:00:00');
...
--
ALTER TABLE `technicians`
  MODIFY `techID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
